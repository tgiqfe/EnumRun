...
namespace EnumRun.ScriptDelivery
{
    ...
    internal class DeleteManager
    {
        ...
        private EnumRun.Logs.ProcessLog.ProcessLogger2 _logger = null;
        ...
        public DeleteManager(string targetDir, string trashPath, EnumRun.Logs.ProcessLog.ProcessLogger2 logger)
        {
